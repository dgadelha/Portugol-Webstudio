/**
 * Definição da linguagem Portugol para o Monaco Editor
 */
...
/**
 * Registra a linguagem Portugol no Monaco
 */
export function registerPortugolLanguage(): void {
  ...
  // Configuração do MonarchTokensProvider para sintaxe
  ...
  } as any); // Removendo a dependência de tipagem IMonarchLanguage
}
